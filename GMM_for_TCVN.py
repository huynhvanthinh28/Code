...
sns.set()
df = pd.read_excel('TCVN.xls')

data = df.iloc[:,np.r_[7:19,19,20,23,24,26]]
...
gmm_features = GaussianMixture(n_components=11).fit(features_normal)
...
labeled_features.to_csv( 'gmm_3.csv')
