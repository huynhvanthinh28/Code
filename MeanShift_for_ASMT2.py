...
data = df.iloc[:,np.r_[8:20,20,21,23,24,25,27]]
...
new_columns = ['SOIL_GROUP', 'MEANSHIFT_PRED', 'MEANSHIFT_GROUP']
new_values = [soil_groups, meanshift_predict, empty_column]
...
labeled_features.to_csv('meanshift_2.csv')
